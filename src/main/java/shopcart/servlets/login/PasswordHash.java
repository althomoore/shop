...
/*
 * Hashes a password using a slow algorithm and a random salt to make
 * dictionary attacks as difficult as possible.
 */
class PasswordHash {
     ...
     */
    static boolean validatePassword(String password, String goodHash)
            throws NoSuchAlgorithmException, InvalidKeySpecException {
